...
public class AccesoryDto extends ProductDto{
    public AccesoryDto(Long idProduct, String productCode, String codeByBranch, String name, BigDecimal price, Integer stock, String description, CategoryDto category, BrandDto brand, PetType petType, String imageProduct, Boolean hypoallergenic, AccesoryType accesoryType) {
